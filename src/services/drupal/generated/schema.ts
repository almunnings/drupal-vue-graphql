...
export type MetaTag = (MetaTagLink | MetaTagProperty | MetaTagValue) & {
  __isUnion?: true
}
...
export type TypeBlockContentInterface = (
  | BlockContentAnotherType
  | BlockContentBasicBlock
) & { __isUnion?: true }

export type TypeBlockContentUnion = (
  | BlockContentAnotherType
  | BlockContentBasicBlock
) & { __isUnion?: true }

/** Entity type media. */
export type TypeMediaInterface = (
  | MediaAudio
  | MediaDocument
  | MediaImage
  | MediaRemoteVideo
...
export type TypeParagraphInterface = (
  | ParagraphBlock
  | ParagraphCallToAction
  | ParagraphMedia
  | ParagraphQuote
...
export type TypeParagraphUnion = (
  | ParagraphBlock
  | ParagraphCallToAction
  | ParagraphMedia
  | ParagraphQuote
...
export interface ImageGenqlSelection {
  ...
  /** Fetch an image style. */
  style?: ImageStyleDerivativeGenqlSelection & {
    __args?: {
...
export interface QueryGenqlSelection {
  ...
  /** Fetch data for a specific NodePage */
  nodePage?: NodePageGenqlSelection & {
    __args: {
  ...
  /** List of all NodePage on the platform. Results are access controlled. */
  nodePages?: NodePageConnectionGenqlSelection & {
    __args?: {
...
const BlockContentAnotherType_possibleTypes: string[] = [
  'BlockContentAnotherType'
]
export const isBlockContentAnotherType = (
  obj?: { __typename?: any } | null
): obj is BlockContentAnotherType => {
  if (!obj?.__typename)
...
const BlockContentBasicBlock_possibleTypes: string[] = [
  'BlockContentBasicBlock'
]
export const isBlockContentBasicBlock = (
  obj?: { __typename?: any } | null
): obj is BlockContentBasicBlock => {
  if (!obj?.__typename)
...
export const isBlockField = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isBlockField"')
...
export const isConnection = (
  ...
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isConnection"')
...
export const isImageStyleDerivative = (
  obj?: { __typename?: any } | null
): obj is ImageStyleDerivative => {
  if (!obj?.__typename)
...
export const isLayoutParagraphsInterface = (
  obj?: { __typename?: any } | null
): obj is LayoutParagraphsInterface => {
  if (!obj?.__typename)
...
const LayoutParagraphsPosition_possibleTypes: string[] = [
  'LayoutParagraphsPosition'
]
export const isLayoutParagraphsPosition = (
  obj?: { __typename?: any } | null
): obj is LayoutParagraphsPosition => {
  if (!obj?.__typename)
...
export const isLayoutPosition = (
  obj?: { __typename?: any } | null
): obj is LayoutPosition => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isLayoutPosition"')
...
export const isMediaDocument = (
  obj?: { __typename?: any } | null
): obj is MediaDocument => {
  if (!obj?.__typename)
...
export const isMediaRemoteVideo = (
  obj?: { __typename?: any } | null
): obj is MediaRemoteVideo => {
  if (!obj?.__typename)
...
const MetaTag_possibleTypes: string[] = [
  'MetaTagLink',
  'MetaTagProperty',
  'MetaTagValue'
]
export const isMetaTag = (
  obj?: { __typename?: any } | null
): obj is MetaTag => {
...
export const isMetaTagLinkAttributes = (
  obj?: { __typename?: any } | null
): obj is MetaTagLinkAttributes => {
  if (!obj?.__typename)
...
export const isMetaTagProperty = (
  obj?: { __typename?: any } | null
): obj is MetaTagProperty => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMetaTagProperty"')
  return MetaTagProperty_possibleTypes.includes(obj.__typename)
}

const MetaTagPropertyAttributes_possibleTypes: string[] = [
  'MetaTagPropertyAttributes'
]
export const isMetaTagPropertyAttributes = (
  obj?: { __typename?: any } | null
): obj is MetaTagPropertyAttributes => {
  if (!obj?.__typename)
...
const MetaTagUnion_possibleTypes: string[] = [
  'MetaTagLink',
  'MetaTagProperty',
  'MetaTagValue'
]
export const isMetaTagUnion = (
  obj?: { __typename?: any } | null
): obj is MetaTagUnion => {
  if (!obj?.__typename)
...
const MetaTagValueAttributes_possibleTypes: string[] = [
  'MetaTagValueAttributes'
]
export const isMetaTagValueAttributes = (
  obj?: { __typename?: any } | null
): obj is MetaTagValueAttributes => {
  if (!obj?.__typename)
...
export const isNodePageConnection = (
  obj?: { __typename?: any } | null
): obj is NodePageConnection => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isNodePageConnection"')
  return NodePageConnection_possibleTypes.includes(obj.__typename)
}

const NodePageEdge_possibleTypes: string[] = ['NodePageEdge']
export const isNodePageEdge = (
  obj?: { __typename?: any } | null
): obj is NodePageEdge => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isNodePageEdge"')
...
export const isParagraphCallToAction = (
  obj?: { __typename?: any } | null
): obj is ParagraphCallToAction => {
  if (!obj?.__typename)
...
export const isParagraphMedia = (
  obj?: { __typename?: any } | null
): obj is ParagraphMedia => {
  if (!obj?.__typename)
...
export const isParagraphQuote = (
  obj?: { __typename?: any } | null
): obj is ParagraphQuote => {
  if (!obj?.__typename)
...
export const isParagraphTable = (
  obj?: { __typename?: any } | null
): obj is ParagraphTable => {
  if (!obj?.__typename)
...
export const isParagraphText = (
  obj?: { __typename?: any } | null
): obj is ParagraphText => {
  if (!obj?.__typename)
...
const Route_possibleTypes: string[] = [
  'RouteExternal',
  'RouteInternal',
  'RouteRedirect'
]
...
export const isRouteEntityUnion = (
  obj?: { __typename?: any } | null
): obj is RouteEntityUnion => {
  if (!obj?.__typename)
...
export const isRouteExternal = (
  obj?: { __typename?: any } | null
): obj is RouteExternal => {
  if (!obj?.__typename)
...
export const isRouteInternal = (
  obj?: { __typename?: any } | null
): obj is RouteInternal => {
  if (!obj?.__typename)
...
export const isSchemaInformation = (
  obj?: { __typename?: any } | null
): obj is SchemaInformation => {
  if (!obj?.__typename)
...
const TypeBlockContentInterface_possibleTypes: string[] = [
  'BlockContentAnotherType',
  'BlockContentBasicBlock'
]
export const isTypeBlockContentInterface = (
  obj?: { __typename?: any } | null
): obj is TypeBlockContentInterface => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTypeBlockContentInterface"')
  return TypeBlockContentInterface_possibleTypes.includes(obj.__typename)
}

const TypeBlockContentUnion_possibleTypes: string[] = [
  'BlockContentAnotherType',
  'BlockContentBasicBlock'
]
export const isTypeBlockContentUnion = (
  obj?: { __typename?: any } | null
): obj is TypeBlockContentUnion => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTypeBlockContentUnion"')
  return TypeBlockContentUnion_possibleTypes.includes(obj.__typename)
}

const TypeMediaInterface_possibleTypes: string[] = [
  'MediaAudio',
  'MediaDocument',
  'MediaImage',
  'MediaRemoteVideo',
...
export const isTypeMediaInterface = (
  obj?: { __typename?: any } | null
): obj is TypeMediaInterface => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTypeMediaInterface"')
  return TypeMediaInterface_possibleTypes.includes(obj.__typename)
}

const TypeMediaUnion_possibleTypes: string[] = [
  'MediaAudio',
  'MediaDocument',
  'MediaImage',
  'MediaRemoteVideo',
...
export const isTypeMediaUnion = (
  obj?: { __typename?: any } | null
): obj is TypeMediaUnion => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTypeMediaUnion"')
  return TypeMediaUnion_possibleTypes.includes(obj.__typename)
}

const TypeNodeInterface_possibleTypes: string[] = ['NodePage']
export const isTypeNodeInterface = (
  obj?: { __typename?: any } | null
): obj is TypeNodeInterface => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTypeNodeInterface"')
  return TypeNodeInterface_possibleTypes.includes(obj.__typename)
}

const TypeParagraphInterface_possibleTypes: string[] = [
  'ParagraphBlock',
  'ParagraphCallToAction',
  'ParagraphMedia',
  'ParagraphQuote',
...
export const isTypeParagraphInterface = (
  obj?: { __typename?: any } | null
): obj is TypeParagraphInterface => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTypeParagraphInterface"')
  return TypeParagraphInterface_possibleTypes.includes(obj.__typename)
}

const TypeParagraphUnion_possibleTypes: string[] = [
  'ParagraphBlock',
  'ParagraphCallToAction',
  'ParagraphMedia',
  'ParagraphQuote',
...
export const isTypeParagraphUnion = (
  obj?: { __typename?: any } | null
): obj is TypeParagraphUnion => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTypeParagraphUnion"')
  return TypeParagraphUnion_possibleTypes.includes(obj.__typename)
}

const TypeTermInterface_possibleTypes: string[] = []
export const isTypeTermInterface = (
  obj?: { __typename?: any } | null
): obj is TypeTermInterface => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTypeTermInterface"')
  return TypeTermInterface_possibleTypes.includes(obj.__typename)
}

const TypeUserInterface_possibleTypes: string[] = ['User']
export const isTypeUserInterface = (
  obj?: { __typename?: any } | null
): obj is TypeUserInterface => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isTypeUserInterface"')
