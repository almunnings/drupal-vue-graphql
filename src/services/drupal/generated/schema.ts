...
export type ConnectionSortKeys =
  | 'CREATED_AT'
  | 'PROMOTED'
  | 'STICKY'
  | 'TITLE'
...
export type ImageStyleAvailable =
  | 'LARGE'
  | 'LARGE2X'
  | 'MEDIUM'
  | 'MEDIUM2X'
...
export interface ImageGenqlSelection {
  ...
  variations?: ImageStyleDerivativeGenqlSelection & {
    __args?: { styles?: (ImageStyleAvailable | null)[] | null }
  }
...
const BlockContentInterface_possibleTypes: string[] = [
  'BlockContentAnotherType',
  'BlockContentBasicBlock'
]
export const isBlockContentInterface = (
  obj?: { __typename?: any } | null
): obj is BlockContentInterface => {
  if (!obj?.__typename)
...
const BlockContentUnion_possibleTypes: string[] = [
  'BlockContentAnotherType',
  'BlockContentBasicBlock'
]
export const isBlockContentUnion = (
  obj?: { __typename?: any } | null
): obj is BlockContentUnion => {
  if (!obj?.__typename)
...
export const isImageStyleUnion = (
  obj?: { __typename?: any } | null
): obj is ImageStyleUnion => {
  if (!obj?.__typename)
...
const MediaInterface_possibleTypes: string[] = [
  'MediaAudio',
  'MediaDocument',
  'MediaImage',
  'MediaRemoteVideo',
...
export const isMediaInterface = (
  obj?: { __typename?: any } | null
): obj is MediaInterface => {
  if (!obj?.__typename)
...
const MediaUnion_possibleTypes: string[] = [
  'MediaAudio',
  'MediaDocument',
  'MediaImage',
  'MediaRemoteVideo',
...
export const isNodeInterface = (
  obj?: { __typename?: any } | null
): obj is NodeInterface => {
  if (!obj?.__typename)
...
const ParagraphInterface_possibleTypes: string[] = [
  'ParagraphBlock',
  'ParagraphCallToAction',
  'ParagraphMedia',
  'ParagraphQuote',
...
export const isParagraphInterface = (
  obj?: { __typename?: any } | null
): obj is ParagraphInterface => {
  if (!obj?.__typename)
...
const ParagraphUnion_possibleTypes: string[] = [
  'ParagraphBlock',
  'ParagraphCallToAction',
  'ParagraphMedia',
  'ParagraphQuote',
...
export const isParagraphUnion = (
  obj?: { __typename?: any } | null
): obj is ParagraphUnion => {
  if (!obj?.__typename)
...
export const isTermInterface = (
  obj?: { __typename?: any } | null
): obj is TermInterface => {
  if (!obj?.__typename)
...
export const isUserInterface = (
  obj?: { __typename?: any } | null
): obj is UserInterface => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUserInterface"')
  return UserInterface_possibleTypes.includes(obj.__typename)
}

const UserUnion_possibleTypes: string[] = ['User']
export const isUserUnion = (
  obj?: { __typename?: any } | null
): obj is UserUnion => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isUserUnion"')
