...
export declare const useRouteStore: import("pinia").StoreDefinition<"route", import("pinia")._UnwrapAll<Pick<{
    routes: Map<string, {
        internal: boolean;
        url: string;
        ...
        __isUnion?: true | undefined;
    }> & Omit<Map<string, Route>, keyof Map<any, any>>;
    errors: Map<string, {
        name: string;
        message: string;
    ...
    fetchRoute: (path: string) => Promise<(Map<string, {
        internal: boolean;
        url: string;
        __typename: "RouteExternal";
        __isUnion?: true | undefined;
        ...
        __typename: "RouteRedirect";
        __isUnion?: true | undefined;
    }> & Omit<Map<string, Route>, keyof Map<any, any>>) | (Map<string, {
        name: string;
        message: string;
        stack?: string | undefined;
    }> & Omit<Map<string, Error>, keyof Map<any, any>>) | {
